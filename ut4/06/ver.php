<?php
$xsd = file_get_contents("06.xsd");
$dtd = file_get_contents("06.dtd");
$xml = file_get_contents("06.xml");
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <title>Ut4.6 Álvaro Calderón</title>
...
<body>
    ...
    <details class="ver">
     ...
     <details class="ver">
        <summary> XML Lugares</summary>
         <pre><?php echo htmlspecialchars($xml); ?></pre>
    </details>
	     <details class="ver">
        <summary> DTD Lugares</summary>
         <pre><?php echo htmlspecialchars($dtd); ?></pre>
    </details>
		     <details class="ver">
        <summary> XSD Lugares</summary>
