<?php
$xsd = file_get_contents("02.xsd");
$dtd = file_get_contents("02.dtd");
...
<head>
    ...
    <title>Ut4.2 Álvaro Calderón</title>
...
<body>
    ...
    <details class="ver">
        <summary>  Email</summary>
         <iframe src="Ut4_02.pdf" width="100%" height="800px"></iframe>

    </details>
     <details class="ver">
        <summary> XML Email</summary>
         <pre><?php echo htmlspecialchars($xml); ?></pre>
    </details>
	     <details class="ver">
        <summary> DTD Email</summary>
         <pre><?php echo htmlspecialchars($dtd); ?></pre>
    </details>
		     <details class="ver">
        <summary> XSD Email</summary>
