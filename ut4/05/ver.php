<?php
$xsd = file_get_contents("05.xsd");
$dtd = file_get_contents("05.dtd");
$xml = file_get_contents("05.xml");
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <title>Ut4.5 Álvaro Calderón</title>
...
<body>
    ...
    <details class="ver">
     ...
     <details class="ver">
        <summary> XML Estudiantes</summary>
         <pre><?php echo htmlspecialchars($xml); ?></pre>
    </details>
	     <details class="ver">
        <summary> DTD Estudiantes</summary>
         <pre><?php echo htmlspecialchars($dtd); ?></pre>
    </details>
		     <details class="ver">
        <summary> XSD Estudiantes</summary>
